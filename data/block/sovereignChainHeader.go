...
// GetEpochStartOutGoingChainDataHandlers returns epoch start outgoing chains data
func (m *EpochStartSovereign) GetEpochStartOutGoingChainDataHandlers() []data.EpochStartOutGoingChainDataHandler {
	if m == nil {
		return nil
	}
